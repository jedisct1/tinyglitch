...
tinyglitch.wasm: main.o.wasm
	wasm-ld --stack-first --strip-all --compress-relocations -o tinyglitch.wasm main.o.wasm wasm-libs/{lib{avutil,avcodec,avformat}.a,libc-wasm.a,libc-builtins.a,libvpx.a,libaom.a}
	-@rm main.o.wasm
